...
use super::types::{MSG_TYPE_PB, PbBroadcastResult, new_pb_broadcast_result};
...
impl PubkeyBroadcastMsg {
    pub fn serialize(&self, keypair: &Keypair, config_index: i32) -> [u8; 102] {
        ...
        let mut signed_bz: [u8; 102] = [0; 102];
...
pub fn deserealize_pb(bz: &Vec<u8>) -> Result<PbBroadcastResult, Error> {
